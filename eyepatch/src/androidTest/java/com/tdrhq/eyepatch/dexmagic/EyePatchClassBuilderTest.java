...
public class EyePatchClassBuilderTest {
    ...
    public void testCheckSuperWithConstructor() throws Throwable {
        ...
        // uh, I don't know why this works.. the autogenerated code
        // only calls the default constructor of FooParent, but
        // there's no default constructor, so it should've really
